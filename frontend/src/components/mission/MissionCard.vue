  ...
  <v-card class="mx-auto" max-width="344" outlined>
          <v-list-item three-line>
            ...
            <v-list-item-avatar tile size="80" color="grey">
              <v-img
                :src="
                  require(`../../assets/img/Theme/${mission.missionType}.jpg`)
                "
              ></v-img
            ></v-list-item-avatar>
          </v-list-item>
          ...
          <v-card-actions>
            ...
            <v-btn
              depressed
              outlined
              v-if="mission.missionStatus === `UNACTIVATED`"
            >
              <router-link
                :to="{
                  name: 'unactivated',
            ...
            <v-btn
              outlined
              depressed
              v-else-if="mission.missionStatus === `OPEN`"
            >
              <router-link
                :to="{
                  name: 'before',
            ...
            <v-btn
              outlined
              depressed
              v-else-if="mission.missionStatus === `ONGOING`"
            >
              <router-link
                :to="{
                  name: 'proceeding',
