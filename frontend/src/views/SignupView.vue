        ...
        <v-row>
          ...
          <v-col cols="4" class="pt-8">
            <div v-if="userIdChk==false || user.userid == null">
              <v-btn color="#fa183e" outlined class="px-0" @click="idcheck">중복 검사</v-btn>
            </div>
            <div v-else-if="userIdChk==true">
              <v-btn outlined color="success" disabled class="px-0" @click="idcheck">중복 검사</v-btn>
            </div>
          </v-col>
        </v-row>
        <v-row>
        ...
        <v-row>
          ...
          <v-col cols="4" class="pt-8">
            <div v-if="userNickChk==false || user.usernickname==null">
              <v-btn color="#fa183e" outlined class="px-0" @click="nickcheck" @keyup.enter="nickcheck">
                중복 검사
              </v-btn>
            </div>
            <div v-else-if="userNickChk==true">
              <v-btn disabled outlined class="px-0" @click="nickcheck" @keyup.enter="nickcheck">
                중복 검사
              </v-btn>
            </div>
            <div>
  ...
  >
    <v-card-text>
      <div class="mb-4">
        ...
        <br>
        ('OctopUS'이하 'OctopUS')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
        <br><br>
        ○ 이 개인정보처리방침은 2022년 1월 1부터 적용됩니다.
        <br><br>
        제1조(개인정보의 처리 목적)
        <br>
        [ OctopUS ]('OctopUS'이하 'OctopUS')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
        <br>
        1. 홈페이지 회원가입 및 관리
        <br>
        ...
        <br>
        ① [ OctopUS ]은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
        <br>
        ...
        1[ 홈페이지 회원가입 및 관리 ]
        <br>
        필수항목 : 이메일, 비밀번호, 로그인ID, 서비스 이용 기록, 결제기록
        <br><br>
        제4조(개인정보의 제3자 제공에 관한 사항)
        <br>
        ① [ OctopUS ]은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
        <br><br>
        제5조(개인정보처리의 위탁에 관한 사항)
        <br>
        ① [ OctopUS ]은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
        <br><br>
        제6조(개인정보의 파기절차 및 파기방법)
        <br>
        ① [ OctopUS ] 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
        <br>
        ...
        1. 파기절차
        <br>
        [ OctopUS ] 은(는) 파기 사유가 발생한 개인정보를 선정하고, [ OctopUS ] 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
        <br><br>
        제7조(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)
        <br>
        ① 정보주체는 OctopUS에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        <br>
        ② 제1항에 따른 권리 행사는OctopUS에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 OctopUS은(는) 이에 대해 지체 없이 조치하겠습니다.
        <br>
        ...
        <br>
        ⑥ OctopUS은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
        <br><br>
        제8조(개인정보의 안전성 확보조치에 관한 사항)
        <br>
        [ OctopUS ]은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
        <br>
        1. 개인정보의 암호화
        <br>
        ...
        <br>
        OctopUS 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.
        <br><br>
        ...
        <br>
        [ OctopUS ] 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다.
        <br>
        이에 따라 [ OctopUS ] 가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은 사항을 고려하였습니다.
        <br><br>
        ...
        <br>
        [ OctopUS ] 은(는) 다음과 같은 목적으로 가명정보를 처리하고 있습니다.
        <br>
        ▶ 법 제28조의4(가명정보에 대한 안전조치 의무 등)에 따른 가명정보의 안전성 확보조치에 관한 사항
        <br><br>
        제13조 (개인정보 보호책임자에 관한 사항)
        <br>
        ① OctopUS 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
        <br><br>
        제14조(국내대리인의 지정)
        <br>
        정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된 [ OctopUS ]의 국내대리인에게 개인정보 관련 고충처리 등의 업무를 위하여 연락을 취할 수 있습니다. [ OctopUS ]은(는) 정보주체의 개인정보 관련 고충처리 등 개인정보 보호책임자의 업무 등을 신속하게 처리할 수 있도록 노력하겠습니다.
        <br><br>
